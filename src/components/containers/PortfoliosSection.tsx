...
const PortfoliosSection = () => {
  // States
  const [visiblePortfolios, setVisiblePortfolios] = useState<any>([]);
      ...
      if (value === "") {
        ...
        setVisiblePortfolios(
          data
            ...
            .filter((portfolio: any) => portfolio.filters.includes(value))
        );
      }
    },
    [data, pageNumber]
    ...
    if (currentFilter === "") {
      ...
      setVisiblePortfolios(
        data
          ...
          .filter((portfolio: any) => portfolio.filters.includes(currentFilter))
      );
    }
